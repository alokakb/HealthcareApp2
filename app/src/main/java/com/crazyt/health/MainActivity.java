...
import com.crazyt.health.fragment.Fragment_Calculate;
import com.crazyt.health.fragment.Fragment_Reminder;
import com.crazyt.health.fragment.Fragment_Walk_and_Step;
import com.crazyt.health.fragment.Fragment_Workout;
import com.crazyt.health.fragment.MainFragment;
...
//        StepDetectionServiceHelper.startAllIfEnabled(true, MainActivity.this);
        ...
        ((Button) dialog.findViewById(R.id.exit_btn_no)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                dialog.dismiss();
            }
        });

        ((Button) dialog.findViewById(R.id.exit_btn_yes)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                dialog.dismiss();
