...
package com.crazyt.health.WalkandStep.persistence;
...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.crazyt.health.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.crazyt.health.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.crazyt.health.STEPS_INSERTED";
