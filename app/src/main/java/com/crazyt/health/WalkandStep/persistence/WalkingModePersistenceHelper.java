...
public class WalkingModePersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_WALKING_MODE_CHANGED = "com.crazyt.health.WALKING_MODE_CHANGED";
    public static final String BROADCAST_EXTRA_OLD_WALKING_MODE = "com.crazyt.health.EXTRA_OLD_WALKING_MODE";
    public static final String BROADCAST_EXTRA_NEW_WALKING_MODE = "com.crazyt.health.EXTRA_NEW_WALKING_MODE";
