...
package com.crazyt.health.WalkandStep.services;
...
import com.crazyt.health.WalkandStep.activities.TrainingActivity;
...
import com.crazyt.health.WalkandStep.persistence.TrainingPersistenceHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.crazyt.health.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.crazyt.health.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.crazyt.health.TOTAL_STEPS";
